defmodule LexinWeb do
  ...
  def sitemaps_path, do: Application.get_env(:lexin, :sitemaps_path)
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: LexinWeb.Router,
        statics: LexinWeb.static_paths()
    end
  end
